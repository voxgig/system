...
# Pages outside the tree. None here: ci/README.md documents the CI
# harness for the people maintaining it, not the package for its users.
EXTRA_PAGES = ()

# Multi-port layout (one directory per language, each carrying its own
# pages). Off here: a single TypeScript package.
PORT_DIRS = False
NOT_PORTS = ()
PORT_PAGES = ()
...
WORKING_DOCS = (
    ...
    (r"\bNEXT\.org\b", "NEXT.org"),
    (r"\b(?:ci/)?COVERAGE\.md\b", "ci/COVERAGE.md"),
...
REQUIRED_PAGES = (
    "docs/explanation/model-wiring.md",
    "docs/how-to/add-elements.md",
    "docs/how-to/customise-templates.md",
